...
export default function Livro() {
  ...
  const livro = { 
    ...
    tipo: "Ficção", 
    faixaEtaria: "+14 anos",
    descricao: "Uma história incrível sobre a jornada de descoberta em um mundo de possibilidades literárias. Este livro mudará sua forma de ver a vida e a tecnologia.",
    ...
    <main className="px-6 py-16 min-h-[70vh]">
      <div className="mx-auto max-w-[1000px] flex flex-col md:flex-row gap-12 bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
        <div className="w-full md:w-1/3 flex-shrink-0">
          <img src={livro.imagem} alt={livro.titulo} className="w-full h-auto object-cover rounded-xl shadow-md" />
        </div>
        ...
        <div className="flex flex-col flex-1 gap-6">
          <div>
            <div className="flex items-center gap-3 mb-3">
              ...
              <span className="text-xs font-bold text-gray-400 uppercase tracking-widest">{livro.faixaEtaria}</span>
            </div>
          ...
          <div className="mt-auto pt-6 flex gap-4">
             ...
             <Link to="/catalogo" className="px-8 py-3 rounded-full font-bold uppercase tracking-wider text-sm border border-gray-300 text-gray-600 hover:border-navy hover:text-navy transition flex items-center justify-center">
               Voltar
             </Link>
          </div>
        </div>
